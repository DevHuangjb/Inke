...
let live_users : String = "http://218.11.0.112/api/live/users?start=0&count=20&id=1509856229604887"
func liveUserApiGet(id:String) -> String {
    return "http://218.11.0.112/api/live/users?start=0&count=20&id=" + id
}
